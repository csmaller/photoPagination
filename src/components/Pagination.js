...
function Pagination(props) {
  ...
  let{
      totalRecords = null, pageLimit = 30, pageNeighbors = 0, currentPage
    } = props;
  let pl= typeof pageLimit === 'number' ? pageLimit : 30;
  totalRecords = typeof totalRecords === 'number' ? totalRecords : 0;
  pageNeighbors = typeof pageNeighbors === 'number' ?
    Math.max(0, Math.min(pageNeighbors, 2)) :
    0;

  let totalPages = Math.ceil(totalRecords / pl);
